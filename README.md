...
```bash
git clone https://github.com/pallavi176/Sensor-Fault-Detection.git
```
...
export MONGODB_URL="mongodb+srv://<username>:<password>@cluster0.sg1qp.mongodb.net/?retryWrites=true&w=majority"
